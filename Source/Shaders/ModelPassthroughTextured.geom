...
layout (location = 2) out vec3 out_worldPos0;
layout (location = 3) out vec3 out_worldPos1;
layout (location = 4) out vec3 out_worldPos2;
layout (location = 5) out uint out_primId;
